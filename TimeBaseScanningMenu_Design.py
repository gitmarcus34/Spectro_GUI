...
class Ui_TBSMenu(object):
    def setupUi(self, TBSMenu):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1863, 26))
    ...
    def retranslateUi(self, TBSMenu):
        ...
        self.label_6.setText(_translate("TBSMenu", "Region for updates and error messages (coming soon)"))
        ...
        self.millisec_label3.setText(_translate("TBSMenu", "ms"))
