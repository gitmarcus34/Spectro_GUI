...
class Ui_TBSMenu(object):
    def setupUi(self, TBSMenu):
        ...
        self.MoveMotor_Button = QtWidgets.QPushButton(self.centralwidget)
        self.MoveMotor_Button.setObjectName("MoveMotor_Button")
        self.gridLayout_9.addWidget(self.MoveMotor_Button, 1, 2, 1, 1)
    ...
    def retranslateUi(self, TBSMenu):
        ...
        self.MoveMotor_Button.setText(_translate("TBSMenu", "Move Grating to Position"))
